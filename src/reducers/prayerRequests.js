...
import { REQUEST_IS_LOADING, REQUEST_FETCH_DATA_SUCCESS, REQUEST_HAS_ERRORED, FILTER_BY_TITLE, GET_NEXT_PRAYER_REQUESTS_PAGE_FROM_API  } from 'appray/src/actions/types';  
    ...
    switch (action.type) {
        ...
        case FILTER_BY_TITLE:
            ...
            const requests = state.all_items ? state.all_items.reduce(function (res, request) {
                if (request.title.toLowerCase().indexOf(action.text_filter.toLowerCase()) >= 0 || 
